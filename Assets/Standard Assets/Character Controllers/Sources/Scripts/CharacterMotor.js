...
// added by CKK at some point to constrain angles in y maze
// Variables for setting up left/right turn constraints during linear track of Tmaze
//var AngleConstraint : float = 60;
//var zLeftAngleConstraint : float = 90 - AngleConstraint;
//var zRightAngleConstraint: float = 90 + AngleConstraint;
//var zConstraintRelease : boolean = false; 
//var xBarrier : float = 180;
...
// added at some point by CKK to constrain angles in y maze
	//Debug.Log(tr.rotation.eulerAngles);

	//Prevents rotating beyond a certain angle in the left direction while running down linear track of TMaze
//	if ((tr.rotation.eulerAngles.y < zLeftAngleConstraint || tr.rotation.eulerAngles.y > 270) && zConstraintRelease == false) {
//		movement.velocity.z=0;
//		movement.velocity.x=10;
//		tr.rotation.eulerAngles.y = zLeftAngleConstraint;
//	}
	
	//Prevents rotating beyond a certain angle in the right direction while running down linear track of TMaze
//	if (tr.rotation.eulerAngles.y > zRightAngleConstraint && tr.rotation.eulerAngles.y < 270 && zConstraintRelease == false) {
//		movement.velocity.z=0;
//		movement.velocity.x=10;
//		tr.rotation.eulerAngles.y = zRightAngleConstraint;
//	}
	
	//Releases left/right rotation constraints at the T-turn point
//	if (tr.position.x > xBarrier) {
//		zConstraintRelease = true;
	
//	}
	
	//Sets left/right rotation constraints always at the beginning of the maze
//	if (tr.position.x < xBarrier) {
//		zConstraintRelease = false;
//		//tr.rotation.eulerAngles.y = 90;
//		//movement.velocity.z = 0;
//	}
