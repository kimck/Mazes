...
public class SaveLocation_Fear_Test : MonoBehaviour {
    ...
    void Start () {
		...
		string message = "{'level':" + "'" + level + "'" + 
			...
			", 'shock':" + Context_Fear_Test.shock +
			", 'led':" + Context_Fear_Test.led +
			"}";
...
//    }
    ...
    public void CollectData (string eventName) {
		...
		if (Context_Fear_Test.shock!="'None'"){
				Context_Fear_Test.shock="'None'";
		}
		
		if (Context_Fear_Test.led!="'None'"){
				Context_Fear_Test.led="'None'";
		}
