...
public class SaveLocation_Fear_Train : MonoBehaviour {
    ...
    void Start () {
		...
		string message = "{'level':" + "'" + level + "'" + 
			...
			", 'shock':" + Context_Fear_Train.shock +
			", 'led':" + Context_Fear_Train.led +
			"}";
...
//    }
    ...
    public void CollectData (string eventName) {
		...
		if (Context_Fear_Train.shock!="'None'"){
				Context_Fear_Train.shock="'None'";
		}
		
		if (Context_Fear_Train.led!="'None'"){
				Context_Fear_Train.led="'None'";
		}
