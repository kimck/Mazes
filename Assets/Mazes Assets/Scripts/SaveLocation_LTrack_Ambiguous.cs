...
public class SaveLocation_LTrack_Ambiguous : MonoBehaviour {
...
//    }
    ...
    public void CollectData (string eventName) {
		...
		if (LTrack_RewardTrigger_Ambiguous.context!="'None'"){
				LTrack_RewardTrigger_Ambiguous.context="'None'";
		}
		
		if (LTrack_RewardTrigger_Ambiguous.outcome!="'None'"){
				LTrack_RewardTrigger_Ambiguous.outcome="'None'";
		}
    }
