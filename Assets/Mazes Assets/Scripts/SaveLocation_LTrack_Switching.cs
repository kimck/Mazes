...
public class SaveLocation_LTrack_Switching : MonoBehaviour {
    ...
    void Start () {
		...
		string message = "{'level':" + "'" + level + "'" + 
			...
			", 'context':" + LTrack_RewardTrigger_Switching.context +
			", 'outcome':" + LTrack_RewardTrigger_Switching.outcome +
			"}";
...
//    }
    ...
    public void CollectData (string eventName) {
		...
		if (LTrack_RewardTrigger_Switching.context!="'None'"){
				LTrack_RewardTrigger_Switching.context="'None'";
		}
		
		if (LTrack_RewardTrigger_Switching.outcome!="'None'"){
				LTrack_RewardTrigger_Switching.outcome="'None'";
		}
    }
