...
public class SaveLocation_LTrack : MonoBehaviour {
    ...
    void Start () {
		...
		string message = "{'level':" + "'" + level + "'" + 
			...
			", 'context':" + LTrack_RewardTrigger.context +
			", 'outcome':" + LTrack_RewardTrigger.outcome +
			"}";
...
//    }
    ...
    public void CollectData (string eventName) {
		...
		if (LTrack_RewardTrigger.context!="'None'"){
				LTrack_RewardTrigger.context="'None'";
		}
		
		if (LTrack_RewardTrigger.outcome!="'None'"){
				LTrack_RewardTrigger.outcome="'None'";
		}
    }
