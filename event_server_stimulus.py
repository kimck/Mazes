...
#            break
	...
	#    print stimulus
        ...
        #elif odor == 'odor2':
        #    self.labjack_logger.execute_task( {'mode':'write','register':6000+3, 'write_value':1} )
	#elif odor == 'None':
        #    self.labjack_logger.execute_task( {'mode':'write','register':6000+2, 'write_value':0} )
        #    self.labjack_logger.execute_task( {'mode':'write','register':6000+3, 'write_value':0} )
